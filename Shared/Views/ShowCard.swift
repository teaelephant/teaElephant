    ...
    var body: some View {
        if info != nil {
            VStack(alignment:.leading) {
                ...
                TypeView(type: info!.data.type.value ?? Type.unknown)
