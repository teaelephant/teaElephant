...
struct TeaShadow {
    ...
    static let light = ShadowStyle(color: Color.black.opacity(0.1), radius: 4, x: 0, y: 2)
    static let medium = ShadowStyle(color: Color.black.opacity(0.15), radius: 8, x: 0, y: 4)
    static let heavy = ShadowStyle(color: Color.black.opacity(0.2), radius: 12, x: 0, y: 6)
}
